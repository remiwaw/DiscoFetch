...
import com.rwawrzyniak.discofetch.business.data.network.implementation.response.SearchResult
...
class SearchResponseNetworkMapper @Inject constructor(): EntityMapper<SearchResult, AlbumCacheEntity> {
